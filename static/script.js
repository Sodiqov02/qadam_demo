(function () {
  ...
  const translations = {
    uz: {
      ...
      arShowcaseTitle: "Taomni stolingizda ko‘ring",
      arShowcaseDescription: "Taomlarni buyurtma berishdan oldin 3D ko‘rinishda oching yoki AR orqali stolingizga joylashtirib ko‘ring.",
      arShowcaseCta: "3D / AR da ko‘rish",
      arPlovDescription: "Palovni har tomondan ko‘ring va stolingizda sinab ko‘ring.",
      arFruitsDescription: "Mevali kompozitsiyani 3D ko‘rinishda oching va stolingizda sinab ko‘ring.",
    ...
    ru: {
      ...
      arShowcaseTitle: "Посмотрите блюдо на своём столе",
      arShowcaseDescription: "Откройте блюда в 3D перед заказом или разместите их на своём столе с помощью AR.",
      arShowcaseCta: "Открыть в 3D / AR",
      arPlovDescription: "Рассмотрите плов со всех сторон и примерьте его на своём столе.",
      arFruitsDescription: "Откройте фруктовую композицию в 3D и примерьте её на своём столе.",
    ...
    en: {
      ...
      arShowcaseTitle: "See the dish on your table",
      arShowcaseDescription: "Explore dishes in 3D before ordering or place them on your table with AR.",
      arShowcaseCta: "View in 3D / AR",
      arPlovDescription: "Explore the plov from every angle and preview it on your table.",
      arFruitsDescription: "Open the fruit arrangement in 3D and preview it on your table.",
